...
namespace SyncronizationBot.Infra.Data.Base.Context
{
    public class SqlServerTransactionalContext : DbContext
    {
        
        #region Constructor

        public SqlServerTransactionalContext(DbContextOptions<SqlServerTransactionalContext> options) : base(options) { }
