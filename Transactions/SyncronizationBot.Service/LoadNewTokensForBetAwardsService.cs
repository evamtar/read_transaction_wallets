...
namespace SyncronizationBot.Service
{
    public class LoadNewTokensForBetAwardsService : BaseService
    {
        public LoadNewTokensForBetAwardsService(IMediator mediator,
                                                ...
                                                IOptions<SyncronizationBotConfig> syncronizationBotConfig) : base(mediator, runTimeControllerRepository, ETypeService.NewTokensBetAwards, syncronizationBotConfig)
        {
            base.LogMessage("Iniciando o serviço de leitura de novos token via Solana RPC");
        }
