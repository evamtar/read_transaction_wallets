...
{
    public class AlertPriceMessageQueueConsumerService : BaseSendTelegramMessageConsumer
    {
        ...
        public AlertPriceMessageQueueConsumerService(IServiceProvider serviceProvider, IOptions<SyncronizationBotConfig> configs, IOptions<LogMessageQueueConfig> configuration) : base(serviceProvider, configuration.Value, configs)
        {
            this.Mediator = null!;
