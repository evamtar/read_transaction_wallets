...
namespace SyncronizationBot.Service.RabbitMQ.Consumers
{
    ...
    public class TokenAlphaMessageQueeConsumerService : BaseSendTelegramMessageConsumer
    {
        ...
        public TokenAlphaMessageQueeConsumerService(IServiceProvider serviceProvider, IOptions<SyncronizationBotConfig> configs, IOptions<LogMessageQueueConfig> configuration) : base(serviceProvider, configuration.Value, configs)
        {
            this.Mediator = null!;
