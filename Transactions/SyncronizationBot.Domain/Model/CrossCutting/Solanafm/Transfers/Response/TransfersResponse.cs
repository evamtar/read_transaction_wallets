...
namespace SyncronizationBot.Domain.Model.CrossCutting.Solanafm.Transfers.Response
{
        ...
        public DateTime DateOfTransfer
        {
            get
            {
                if (Timestamp.HasValue)
                    return DateTimeTicks.Instance.ConvertTicksToDateTime((long)Timestamp.Value);
                else
